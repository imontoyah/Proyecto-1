"""
Created on Wed May 19 10:55:39 2021
...
input_file_path = 'GanadoSano.csv'
output_file_path = 'compress.lz77'
output_file_path2 = 'output.csv'
compressed_data = compressor.compress(input_file_path,output_file_path)
#input_file_path = '/Users/isabella/Downloads/input.txt'
#output_file_path = '/Users/isabella/Downloads/LZ77-Compressor-master/src'
  # or assign decompressed data into a variable
decompressed_data = compressor.decompress(output_file_path,output_file_path2)
